...
function Starlight:CreateWindow(WindowSettings)
	...
	StarlightUI.MobileToggle.Image = ""
	StarlightUI.MobileToggle.BackgroundTransparency = 0.3		local size = mainWindow.Size
	...
	function TabSection:CreateTab(TabSettings, TabIndex)
		...
		local Tab = {
			...
			Groupbox.Instance.Name = "GROUPBOX_" .. tostring(GroupIndex or "0")				local targetColumn = Tab.Instances.Page["Column_" .. NewGroupboxSettings.Column]
				if targetColumn then
					...
					Groupbox.Instance.Parent = Tab.Instances.Page:FindFirstChildOfClass("ScrollingFrame") or Tab.Instances.Page
				end

				Starlight.Window.TabSections[Name].Tabs[TabIndex].Groupboxes[GroupIndex].Values =
					NewGroupboxSettings
			end				function Groupbox:Destroy()
			...
			local targetColumn = Tab.Instances.Page["Column_" .. GroupboxSettings.Column]
			if targetColumn then
				Groupbox.Instance.Parent = targetColumn
			else
				warn("Column " .. GroupboxSettings.Column .. " does not exist in tab. Creating default columns.")
				Groupbox.Instance.Parent = Tab.Instances.Page:FindFirstChildOfClass("ScrollingFrame") or Tab.Instances.Page
			end
		...
		end			--function Tab:CreateTabbox(TabboxSettings) -- coming soon
